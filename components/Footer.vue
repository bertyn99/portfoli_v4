    ...
    <div class="footer-bg">
      <div class="footer-container container grid mx-auto px-5">
        ...
        <div class="footer-socials">
          <a href="facebook.com/" target="_blank" class="footer-social">
            <svg
          ...
          <a href="instagram.com/" target="_blank" class="footer-social">
            <svg
              class="h-5 w-5 footer-social"
          ...
          <a href="linkedin.com/" target="_blank" class="footer-social"
            ><svg
              id="Bold"
              enable-background="new 0 0 24 24"
              class="h-5 w-5 footer-social"
