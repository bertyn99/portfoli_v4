<template>
  <footer class="footer">
    <div class="footer-bg">
      <div class="footer-container container grid mx-auto px-5">
        <div>
          <h1 class="footer-title">Bertyn Boulikou</h1>
          <span class="footer-subtitle">Developpeur FullStack Freelance</span>
        </div>
        ...
        <div class="footer-socials">
          <a href="https://www.facebook.com/helenbertyn.boulikoudamours" target="_blank" class="footer-social">
            <svg class="h-5 w-5 footer-social" enable-background="new 0 0 24 24" viewBox="0 0 24 24"
          ...
          <a href="https://github.com/bertyn99" target="_blank" class="footer-social">
            <svg class="h-6 w-6 footer-social" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/bertyn-boulikou/" target="_blank" class="footer-social"><svg id="Bold"
              enable-background="new 0 0 24 24" class="h-5 w-5 footer-social" viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      <p class="footer-copy">&#169; Bertyn. Tous drois réserved</p>
    </div>
  </footer>
</template>
