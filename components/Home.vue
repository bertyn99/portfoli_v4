    ...
    <div class="home-container container mx-auto px-4 sm:px-6 lg:px:8 grid gap-6">
      <div class="home-content">
        ...
        <div class="home-data">
          ...
          <the-button link="#contact" class="button button-flex">Contactez-moi<svg xmlns="http://www.w3.org/2000/svg"
              class="button-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
