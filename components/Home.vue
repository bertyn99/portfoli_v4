<template>
  <section class="@container home shell-section">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div class="grid grid-cols-[max-content] gap-y-4 md:mr-4">
          <a href="https://www.facebook.com/helenbertyn.boulikoudamours"
            class="text-xl text-primary fill-current transition duration-300 hover:text-primary-alt"><svg
              class="h-5 w-5" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a href="https://github.com/bertyn99"
            class="text-xl text-primary fill-current transition duration-300 hover:text-primary-alt"><svg
          ...
          <a href="https://www.linkedin.com/in/bertyn-boulikou/"
            class="text-xl text-primary fill-current transition duration-300 hover:text-primary-alt"><svg id="Bold"
        ...
        <div class="inline-flex justify-center md:justify-self-center">
          <svg class="w-48 fill-current text-primary lg:w-72 xl:w-80" viewBox="0 0 200 187"
        ...
        <div class="[grid-column:1/3] md:[grid-column:initial]">
          ...
          <the-button link="https://cal.com/bertyn-boulikou"
            class="button button-flex inline-flex items-center">Discutons de votre projet<svg
              xmlns="http://www.w3.org/2000/svg" class="button-icon ml-2 h-6 w-6 transition duration-300" fill="none"
          ...
          <nuxt-link
            to="#about"
            class="button-flex mt-8 flex items-center text-primary transition duration-300 hover:translate-y-1 hover:transform"
          >
