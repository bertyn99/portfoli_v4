<template>
  <section class="home section">
    <div class="home-container container mx-auto px-4 sm:px-6 lg:px:8 grid gap-6">
      <div class="home-content">
        <div class="home-social">
          <a href="https://www.facebook.com/helenbertyn.boulikoudamours" class="home-social-icon"><svg class="h-5 w-5"
          ...
          <a href="https://github.com/bertyn99" class="home-social-icon"><svg class="h-5 w-5" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/bertyn-boulikou/" class="home-social-icon"><svg id="Bold"
        ...
        -0.149132 97.9666 0.00163737C136.23 0.303176 174.193 10.857 190.312 36.4879Z" />
              <image class="home-blob-img" x="14" y="18" xlink:href="/img/bertyn.png" />
            </g>
          </svg>
        </div>
        <div class="home-data">
          ...
          <the-button link="https://cal.com/bertyn-boulikou" class="button button-flex">Discutons de votre projet<svg
              xmlns="http://www.w3.org/2000/svg" class="button-icon" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
